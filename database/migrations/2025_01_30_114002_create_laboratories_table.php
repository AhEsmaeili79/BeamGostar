...
return new class extends Migration
{
    ...
    GROUP BY c.id, ca.id, a.id, fc.id,c.national_code, c.nationality, c.mobile, c.customer_type, c.clearing_type, ca.acceptance_date, ca.tracking_code, fc.scan_form, ca.description, ca.priority, ca.status, fc.state, fc.date_success
");
    }
