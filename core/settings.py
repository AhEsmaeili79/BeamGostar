...
SECRET_KEY = 'django-insecure-8d3(dp)0xk6unsc)qf@6#bjf7rm-u=77n7cujh*i10*)@55^2-'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.miscellaneous.context_processors.menu_context_processor',
            ],
        },
    },
]
...
# Set Persian (Farsi) as the default language
# LANGUAGE_CODE = 'fa'
